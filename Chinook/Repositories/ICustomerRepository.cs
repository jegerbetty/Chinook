...
namespace Chinook.Repositories
{
    public interface ICustomerRepository
    {
        ...
        public Customer GetCustomer(int id); //Returns one customer by Id. get one customer by Id. display: Id, firstname, lastname, country, postal cost, phone number, email
        public Customer GetCustomer(string name); //get one customer by name (HINT: LIKE keyword can help for partial matches). display: Id, firstname, lastname, country, postal cost, phone number, email
